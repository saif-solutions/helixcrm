...
-- Email Templates
ALTER TABLE email_templates ADD CONSTRAINT email_templates_name_organization_unique UNIQUE (name, "organizationId");
...
-- Webhooks
ALTER TABLE webhooks ADD CONSTRAINT webhooks_name_organization_unique UNIQUE (name, "organizationId");
...
-- Files
ALTER TABLE files ADD CONSTRAINT files_filename_organization_unique UNIQUE (filename, "organizationId");
