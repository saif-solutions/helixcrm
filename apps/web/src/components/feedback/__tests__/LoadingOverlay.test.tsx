...
describe('LoadingOverlay', () => {
  ...
  it('should display custom message', () => {
    render(<LoadingOverlay isLoading={true} message="Processing data..." />);
  ...
  it('should have transparent background when transparent is true', () => {
    render(<LoadingOverlay isLoading={true} transparent={true} />);
  ...
  it('should have opaque background when transparent is false', () => {
    render(<LoadingOverlay isLoading={true} transparent={false} />);
