  ...
  React.forwardRef<BadgeRef, BadgeProps>(
    (
      ...
      const badgeClass = cn(
        ...
        // State classes
        clickable &&
          'cursor-pointer hover:opacity-90 active:opacity-80 transition-opacity focus:outline-none focus:ring-2 focus:ring-offset-1 focus-visible:ring-2 focus-visible:ring-offset-1',
      ...
      return (
        ...
        >
          ...
          {/* Badge Content */}
          <span className={shouldTruncate ? 'truncate' : ''}>{children}</span>
