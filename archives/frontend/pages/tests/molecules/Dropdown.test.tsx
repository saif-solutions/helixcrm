...
>(({ tabIndex = 0, disabled, ...props }, ref) => (
  <button ref={ref} data-testid="test-trigger" tabIndex={tabIndex} disabled={disabled} {...props}>
    Open Dropdown
  </button>
));
...
describe('Dropdown - Basic Rendering', () => {
  ...
  test('applies custom data-testid to root element', () => {
    render(
      <Dropdown trigger={<TestTrigger />} data-testid="custom-dropdown">
        <Dropdown.Item>Item 1</Dropdown.Item>
      </Dropdown>,
    );
  ...
  test('renders with items prop', async () => {
    render(<Dropdown trigger={<TestTrigger />} items={defaultItems} />);
  ...
  test('renders with groups prop', async () => {
    const groups = [
      ...
      {
        label: 'Settings',
        items: [{ id: '3', label: 'Preferences', onClick: vi.fn() }],
      },
    ];

    render(<Dropdown trigger={<TestTrigger />} groups={groups} />);
...
describe('Dropdown - Interactions', () => {
  ...
  test('calls onOpenChange when opening/closing', async () => {
    ...
    render(
      <Dropdown trigger={<TestTrigger />} onOpenChange={onOpenChange}>
        <Dropdown.Item>Item 1</Dropdown.Item>
      </Dropdown>,
    );
  ...
  test('closes when item is selected (closeOnSelect=true)', async () => {
    ...
    render(
      <Dropdown trigger={<TestTrigger />} closeOnSelect={true}>
  ...
  test('does not close when item is selected (closeOnSelect=false)', async () => {
    ...
    render(
      <Dropdown trigger={<TestTrigger />} closeOnSelect={false}>
        <Dropdown.Item onSelect={onSelect}>Click me</Dropdown.Item>
      </Dropdown>,
    );
  ...
  test('closes when clicking outside (closeOnOutsideClick=true)', async () => {
    render(
      <div>
        ...
        <Dropdown trigger={<TestTrigger />} closeOnOutsideClick={true}>
          <Dropdown.Item>Item 1</Dropdown.Item>
        </Dropdown>
      </div>,
    );
  ...
  test('does not close when clicking outside (closeOnOutsideClick=false)', async () => {
    render(
      <div>
        <button data-testid="outside-button">Outside button</button>
        <Dropdown trigger={<TestTrigger />} closeOnOutsideClick={false}>
          <Dropdown.Item>Item 1</Dropdown.Item>
        </Dropdown>
      </div>,
    );
...
describe('Dropdown - Keyboard Navigation', () => {
  ...
  test('closes with Escape key', async () => {
    render(
      <Dropdown trigger={<TestTrigger />} closeOnEscape={true}>
        <Dropdown.Item>Item 1</Dropdown.Item>
      </Dropdown>,
    );
  ...
  test('focuses first item when opened with keyboard', async () => {
    render(
      <Dropdown trigger={<TestTrigger />} lockFocus={true}>
...
describe('Dropdown - Prop Variations', () => {
  test('disabled trigger prevents interaction', async () => {
    ...
    render(
      <Dropdown trigger={<TestTrigger disabled />} onOpenChange={onOpenChange}>
        <Dropdown.Item>Item 1</Dropdown.Item>
      </Dropdown>,
    );
  ...
  test('different size variants render without errors', () => {
    ...
    sizes.forEach((size) => {
      const { unmount } = render(
        <Dropdown trigger={<TestTrigger />} size={size}>
...
describe('Dropdown - Edge Cases', () => {
  test('renders without children (empty dropdown)', () => {
    ...
    render(<Dropdown trigger={<TestTrigger />} />);
    ...
    const Component = () => {
      ...
      return (
        <>
          ...
          <Dropdown trigger={<TestTrigger />} open={open} onOpenChange={setOpen}>
...
describe('Dropdown - Ref API', () => {
  test('imperative ref methods exist and work', async () => {
    ...
    render(
      <Dropdown ref={ref} trigger={<TestTrigger />}>
        <Dropdown.Item>Item 1</Dropdown.Item>
        <Dropdown.Item>Item 2</Dropdown.Item>
...
describe('Dropdown - Performance & Robustness', () => {
  ...
  test('handles large item lists efficiently', async () => {
    ...
    render(<Dropdown trigger={<TestTrigger />} items={manyItems} maxHeight="300px" />);
...
describe('Dropdown - Snapshot Tests', () => {
  test('matches trigger snapshot', () => {
    render(
      <Dropdown trigger={<TestTrigger />} data-testid="dropdown-root">
