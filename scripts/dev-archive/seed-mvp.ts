...
async function seedMVP() {
  console.log('��� HELIXCRM MVP SEED SCRIPT');
  console.log('==============================\n');
  ...
  try {
    ...
    console.log(`✅ Created pipeline with ${stages1.length} stages`);
    ...
    console.log(`✅ Created ${contacts1.length} contacts and ${deals1.length} deals`);

    // ==================== ORGANIZATION 2 ====================
    console.log('\n��� ORGANIZATION 2: Marketing Pros LLC');
    console.log('----------------------------------------');
    ...
    console.log(`✅ Created pipeline with ${stages2.length} stages`);
    ...
    console.log(`✅ Created ${contacts2.length} contacts and ${deals2.length} deals`);

    // ==================== SUMMARY ====================
    console.log('\n��� MVP SEED COMPLETE!');
    console.log('=====================');
    console.log(`��� Organizations: 2`);
    console.log(`��� Users: 2 (SystemAdmin each)`);
    console.log(`��� Contacts: 4 (2 per org)`);
    console.log(`��� Pipelines: 2 (with 4 stages each)`);
    console.log(`��� Deals: 4 (2 per org, including 1 won deal)`);
