...
interface DropdownComponent extends React.ForwardRefExoticComponent<DropdownProps & React.RefAttributes<DropdownRef>> {
  ...
  RadioGroup: React.ForwardRefExoticComponent<DropdownRadioGroupProps & React.RefAttributes<HTMLDivElement>>;
    ...
    React.useImperativeHandle(
      ...
      () => ({
        ...
        updatePosition: () => {
          ...
          console.warn('Dropdown.updatePosition() is not supported. Radix UI handles positioning automatically.');
        },
        isOpen: () => open,
