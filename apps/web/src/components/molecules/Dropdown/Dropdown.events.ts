...
export type DropdownOpenChangeHandler =
  (open: boolean, event?: NormalizedDropdownEvent | null) => void;

export type DropdownSelectHandler =
  (value: string, event?: NormalizedDropdownEvent | null) => void;
...
export function normalizeDropdownEvent(
  event: DropdownEvent
