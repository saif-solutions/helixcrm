...
async function runTests() {
  ...
  const imports = [
    ...
    {
      name: 'EvidenceStorageService',
      path: './src/shared/compliance/evidence-storage/evidence-storage.service',
    },
    {
      name: 'ComplianceSchedulerService',
      path: './src/shared/compliance/compliance-scheduler.service',
    },
  ];
